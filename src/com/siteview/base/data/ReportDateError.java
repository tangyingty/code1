...
public class ReportDateError {
	...
	public Date getM_latest_create_time() {
		return m_latest_create_time;
	}

	public void setM_latest_create_time(Date m_latest_create_time) {
		this.m_latest_create_time = m_latest_create_time;
	}

	public float getM_disablePercent() {
		return m_disablePercent;
	}

	public void setM_disablePercent(float percent) {
		m_disablePercent = percent;
	}

	public void setM_begin_date(Date m_begin_date) {
		this.m_begin_date = m_begin_date;
	}

	public void setM_end_date(Date m_end_date) {
	...
	public ReportDateError(Date begin_date, Date end_date) {
	...
	public Map<String, Map<String, String>> getReportDateSpecial(String nodeids) throws Exception {
		this.setNodeids(nodeids);
		m_fmap = UnivData.queryReportData_oneByOne(nodeids, false, true, null, null, null, m_begin_date, m_end_date);
//		if (nodeids.contains("1.31.2.1.1")){
//			System.out.println(nodeids);
//			System.out.println(m_fmap);
//		}
		return m_fmap;
	}
	public Map<String, Map<String, String>> getErrorReportDateSpecial(String nodeids) throws Exception {
		this.setNodeids(nodeids);
		m_fmap = UnivData.queryReportErrorData_oneByOne(nodeids, false, true, null, null, null, m_begin_date, m_end_date);
//		if (nodeids.contains("1.31.2.1.1")){
//			System.out.println(nodeids);
//			System.out.println(m_fmap);
//		}

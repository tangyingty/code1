...
/*			if (LDAPProviderUrl.getValue() != null && !LDAPProviderUrl.getValue().isEmpty()
			...
			String minfo=loginname+" "+Labels.getLabel("In")+OpObjectId.user_manage.name+Labels.getLabel("Conducting")+OpTypeId.add.name+Labels.getLabel("Operation")+OpTypeId.add.name+"了 "+userName.getValue();

...
public class DiagnosisTimer extends Timer {
	...
	public void getTooltiptext(TooltipPopup tooltippopup, Diagnosis diagnosis) {
		tooltippopup.setTitle(Labels.getLabel("DiagnosticInformation"));
		tooltippopup.setImage("/main/images/diagnosis.gif");
		tooltippopup.addDescription(Labels.getLabel("Name"), diagnosis.getName());
		tooltippopup.addDescription(Labels.getLabel("Des"), diagnosis.getDescription());
		StringBuffer sb = new StringBuffer();
		for (String message : diagnosis.getResultList()){
			sb.append(message);
			sb.append("\n");
		}
		tooltippopup.addDescription(Labels.getLabel("DiagnosisResults"), sb.toString());
	}		
}

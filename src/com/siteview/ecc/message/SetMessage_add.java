...
public class SetMessage_add extends GenericAutowireComposer {
	...
	public void onSave(Event event)throws Exception{
		...
		try{
			...
			String minfo=loginname+" "+Labels.getLabel("In")+OpObjectId.sms_set.name+Labels.getLabel("Conducting")+OpTypeId.add.name+Labels.getLabel("OperationAddInformationTo:")+name.getValue();

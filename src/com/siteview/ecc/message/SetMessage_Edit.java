 ...
 */
	...
	public void onSaveEdit(Event event)throws Exception{
		...
		try{
			...
			String minfo=loginname+" "+Labels.getLabel("In")+OpObjectId.sms_set.name+Labels.getLabel("Conducting")+OpTypeId.edit.name+Labels.getLabel("AfterOperationEditInformationFor:")+name.getValue();

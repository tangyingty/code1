			...
			for (Iterator<Listitem> it = s.iterator(); it.hasNext();) {
				...
				if(deleteflag){
					try{
						...
						String minfo = loginname + " " + Labels.getLabel("In")+ OpObjectId.absolute_task.name + Labels.getLabel("Conducting")+ OpTypeId.del.name + Labels.getLabel("OperationDeleteItem:") + name;

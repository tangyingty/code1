...
public class TaskItemRenderer extends ListModelList implements ListitemRenderer {
	...
	class ItemClickListener implements org.zkoss.zk.ui.event.EventListener {
		...
		public void onEvent(Event event) throws Exception {
			...
			new Listcell(Labels.getLabel("SundayW")).setParent(li0);
			new Listcell((t.getAllow0().equals("1") ? Labels.getLabel("Enable") : Labels.getLabel("Disable")))
					.setParent(li0);
			...
			new Listcell(Labels.getLabel("MondayW")).setParent(li1);
			new Listcell((t.getAllow1().equals("1") ? Labels.getLabel("Enable") : Labels.getLabel("Disable")))
					.setParent(li1);
			s = t.getStart1().split(" ");
			if (s.length == 1)
			...
			new Listcell(Labels.getLabel("TuesdayW")).setParent(li2);
			new Listcell((t.getAllow2().equals("1") ? Labels.getLabel("Enable") : Labels.getLabel("Disable")))
					.setParent(li2);
			s = t.getStart2().split(" ");
			if (s.length == 1)
			...
			new Listcell(Labels.getLabel("WednesdayW")).setParent(li3);
			new Listcell((t.getAllow3().equals("1") ? Labels.getLabel("Enable") : Labels.getLabel("Disable")))
					.setParent(li3);
			s = t.getStart3().split(" ");
			if (s.length == 1)
			...
			new Listcell(Labels.getLabel("ThursdayW")).setParent(li4);
			new Listcell((t.getAllow4().equals("1") ? Labels.getLabel("Enable") : Labels.getLabel("Disable")))
					.setParent(li4);
			s = t.getStart4().split(" ");
			if (s.length == 1)
			...
			new Listcell(Labels.getLabel("FridayW")).setParent(li5);
			new Listcell((t.getAllow5().equals("1") ? Labels.getLabel("Enable") : Labels.getLabel("Disable")))
					.setParent(li5);
			s = t.getStart5().split(" ");
			if (s.length == 1)
			...
			new Listcell(Labels.getLabel("SaturdayW")).setParent(li6);
			new Listcell((t.getAllow6().equals("1") ? Labels.getLabel("Enable") : Labels.getLabel("Disable")))
					.setParent(li6);
			s = t.getStart6().split(" ");
			if (s.length == 1)
			...
			lh1.setLabel(Labels.getLabel("Plan"));
			lh1.setAlign("left");
			Listheader lh2 = new Listheader();
			lh2.setLabel(Labels.getLabel("State"));
			lh2.setAlign("left");
			Listheader lh3 = new Listheader();
			lh3.setLabel(Labels.getLabel("Start"));
			lh3.setAlign("left");
			lh1.setParent(lh);
			lh2.setParent(lh);
			lh3.setParent(lh);
			if (t.getType().equals("2")) {
				...
				lh4.setLabel(Labels.getLabel("End"));
				lh4.setAlign("left");
				lh4.setParent(lh);

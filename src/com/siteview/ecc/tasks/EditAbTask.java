...
public class EditAbTask extends GenericForwardComposer {
	...
	public void onApply(Event event) throws Exception {
		...
		{
			String minfo=loginname+" "+Labels.getLabel("In")+OpObjectId.absolute_task.name+Labels.getLabel("Conducting")+OpTypeId.edit.name+Labels.getLabel("OperationEditItem:")+nameTextbox.getValue();
			...
			String minfo=loginname+" "+Labels.getLabel("In")+OpObjectId.absolute_task.name+Labels.getLabel("Conducting")+OpTypeId.add.name+Labels.getLabel("OperationAddingItemTo:")+nameTextbox.getValue();

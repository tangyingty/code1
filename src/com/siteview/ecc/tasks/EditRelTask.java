...
public class EditRelTask extends GenericForwardComposer {
	...
	public void onApply(Event event) throws Exception {
		...
		{
			String minfo=loginname+" "+Labels.getLabel("In")+OpObjectId.relative_task.name+Labels.getLabel("Conducting")+OpTypeId.edit.name+Labels.getLabel("OperationEditItem:")+nameTextbox.getValue();
			...
			String minfo=loginname+" "+Labels.getLabel("In")+OpObjectId.relative_task.name+Labels.getLabel("Conducting")+OpTypeId.add.name+Labels.getLabel("OperationAddingItemTo:")+nameTextbox.getValue();

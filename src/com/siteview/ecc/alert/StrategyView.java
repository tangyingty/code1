	...
	public void onSave() throws InterruptedException {
		try {
			...
			if (strategyname == null || "".equals(strategyname))
				throw new Exception(Labels.getLabel("EnterNameAlarmStrategy"));
			
			//应用到那些结点
			Treeitem item = getTree().getSelectedItem();
			if (item == null)
				throw new Exception(Labels.getLabel("SelectNodeApplicationStrategy"));
			...
			if (typeList == null || typeList.size() == 0) 
				throw new Exception(Labels.getLabel("SelectTypeApplicationStrategy"));

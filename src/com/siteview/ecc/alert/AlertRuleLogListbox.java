...
public class AlertRuleLogListbox extends AbstractListbox {
	...
	public List<String> getListheader() {
		String[] listheader = {Labels.getLabel("AlarmTime"),Labels.getLabel("AlarmName"),Labels.getLabel("DeviceNameTile"),
				Labels.getLabel("MonitorName"),Labels.getLabel("AlarmType"),Labels.getLabel("AlarmReceiver"),Labels.getLabel("AlarmStatus")};
	...
	protected Listhead buildListheader(){
		...
		lh.setSizable(true);
		if(listhead.contains(Labels.getLabel("AlarmTime"))){
			Listheader lr1 = getListheader(Labels.getLabel("AlarmTime"), "17%", "auto");
			lr1.setParent(lh);
		}
		if(listhead.contains(Labels.getLabel("AlarmName"))){
			Listheader lr2 = getListheader(Labels.getLabel("AlarmName"), "18%", "auto");
			lr2.setParent(lh);
		}
		if(listhead.contains(Labels.getLabel("DeviceNameTile"))){
			Listheader lr3 = getListheader(Labels.getLabel("DeviceNameTile"), "15%", "auto");
			lr3.setParent(lh);
		}
		if(listhead.contains(Labels.getLabel("MonitorName"))){
			Listheader lr4 = getListheader(Labels.getLabel("MonitorName"), "20%", "auto");
			lr4.setParent(lh);
		}
		if(listhead.contains(Labels.getLabel("AlarmType"))){
			Listheader lr5 = getListheader(Labels.getLabel("AlarmType"), "10%", "auto");
			lr5.setId("alertlogtype_header");
			lr5.setParent(lh);
		}
		if(listhead.contains(Labels.getLabel("AlarmReceiver"))){
			Listheader lr6 = getListheader(Labels.getLabel("AlarmReceiver"), "10%", "auto");
			lr6.setParent(lh);
		}
		if(listhead.contains(Labels.getLabel("AlarmStatus"))){
			Listheader lr7 = getListheader(Labels.getLabel("AlarmStatus"), "10%", "auto");

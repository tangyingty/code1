	...
	class OkClickListener implements org.zkoss.zk.ui.event.EventListener {
		...
		public void onEvent(Event event) throws Exception {
			try{
				...
				if(getAlertReceiver().getValue().equals(Labels.getLabel("Other")) && getOtherTelNo().getValue().equals("")){
					Message.showInfo(Labels.getLabel("AlarmMessageReceivingAddressNotEmpty"));
					return;
				}

...
public class MonitorInfoListbox extends AbstractListbox {
	...
	public List<String> getListheader() {
		return new ArrayList<String>(Arrays.asList(new String[] { Labels.getLabel("State"),
				Labels.getLabel("Group"),Labels.getLabel("Equipment"), Labels.getLabel("Name"), 
				Labels.getLabel("Editor"), Labels.getLabel("Refresh"),
				Labels.getLabel("UpdateTime") ,Labels.getLabel("Des")}));
	}
				...
				for(String head : listhead){
					...
					if(head.equals(Labels.getLabel("Editor"))){
						...
						Component c2 = BaseTools.getWithLink(
								"",Labels.getLabel("Editor"),"/main/images/alert/edit.gif"
					...
					if(head.equals(Labels.getLabel("Refresh"))){
						Listcell cell = new Listcell();
						cell.setTooltiptext(monitorName);
						Component c2 = BaseTools.getWithLink(
								"",Labels.getLabel("Refresh"),"/main/images/button/ico/ref_bt.gif"

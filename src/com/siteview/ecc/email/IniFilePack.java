...
public class IniFilePack
{
	...
	public IniFilePack(String fileName)
	{
		m_fileName = fileName;
	}
	
	public IniFilePack(String fileName, String section)
	{
		m_fileName = fileName;
		m_sections = section;
	}
	
	public IniFilePack(String fileName, String section, Map<String, String> data)
	{
		m_fileName = fileName;
		m_sections = section;
...
*/	
	...
	public ArrayList<String> getKeyList(String section)
	{
		ArrayList<String> ret= new ArrayList<String>();
...
//		IniFile ini= new IniFile("general.ini","IPCheck");
		IniFilePack ini= new IniFilePack("test.ini.ini");
		ArrayList<String> l;
		try
		{
			ini.load();

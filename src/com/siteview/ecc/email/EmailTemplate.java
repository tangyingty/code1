...
public class EmailTemplate extends GenericAutowireComposer {
	...
	public void onAdd(Event event)throws Exception{
		try{
			...
			String minfo=loginname+" "+Labels.getLabel("In")+OpObjectId.email_template.name+Labels.getLabel("Conducting")+OpTypeId.add.name+Labels.getLabel("EmailTemplateOperationInformationItemsAddedTo:")+templateTextbox.getValue();

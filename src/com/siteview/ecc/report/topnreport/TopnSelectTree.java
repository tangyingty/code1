...
public class TopnSelectTree extends Tree {
	...
	class TreeitemOpenListener implements org.zkoss.zk.ui.event.EventListener {
		...
		private TopnSelectTree tree;
		public TreeitemOpenListener(BaseTreeitem treeitem,TopnSelectTree tree) throws Exception{

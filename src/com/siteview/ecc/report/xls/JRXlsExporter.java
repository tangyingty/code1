 ...
 */
package com.siteview.ecc.report.xls;
 ...
 * @version $Id: JRXlsExporter.java 3190 2009-11-06 14:45:44Z teodord $
 */
public class JRXlsExporter extends JRXlsAbstractExporter
{
	 ...
	 *
	 */
	protected short whiteIndex = (new HSSFColor.AQUA()).getIndex();
	protected short blackIndex = (new HSSFColor.AQUA()).getIndex();
...
//		emptyCellStyle.setFillForegroundColor((new HSSFColor.WHITE()).getIndex());
	...
	{
		sheet.setColumnWidth(col, 60 * width);
	}
	...
	protected void setRowHeight(int rowIndex, int lastRowHeight)
	{
		...
		row.setHeightInPoints((float)(lastRowHeight*1.5));
	}

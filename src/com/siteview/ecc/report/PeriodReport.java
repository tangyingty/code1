...
public class PeriodReport extends GenericForwardComposer {
	...
	private Panel createListbox(Report report1,String sub1,Report report2,String sub2,int index, String title) {
		...
		box.setWidth("100%");
		ChartUtil.addListhead(box, Labels.getLabel("Name"),Labels.getLabel("MaximumValue"),Labels.getLabel("AverageValue"),
				Labels.getLabel("MinimumValue"),Labels.getLabel("MaximumTime"));
